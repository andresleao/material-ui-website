    ...
    <Grid container direction="column">
      ...
      >
        <Grid item lg>
          <img
            src={vision}
            alt="mountain through bonoculars"
            style={{
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img src={review} alt="margnifying glass" width="100%" />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            ...
            width="100%"
            style={{
              maxWidth: matchesMD ? 150 : 200,
              maxHeight: matchesMD ? 500 : 800,
            }}
          />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img src={maintain} alt="wrench tightening bolts" width="100%" />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            ...
            width="100%"
            style={{ maxWidth: matchesMD ? 600 : 700 }}
          />
        </Grid>
      </Grid>
    </Grid>
