...
exports.sendMail = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    const {
      name, email, phone,
      message, total, service,
      platforms, features, customFeatures,
      users, category,
    } = request.query;
    let mailOptions;
    if (total) {
                                          ...
                                          >
                                            ...
                                            <tr>
                                              ...
                                              >
                                                <a
                                                  href=
                                                  "mailto:andreleao@gmail.com"
                                                  style="color:#ffffff;
                                                   text-decoration:
                                                   none!important"
                                                  >andreleao@gmail.com</a
                                                >
                                              </td>
                                            </tr>
                                          </table>
                                                ...
                                                <td
                                                  ...
                                                  "padding:20px 0px 0px 0px;
                                                   font-family: 'Roboto',
                                                    ...
                                                    text-align:center;"
                                                >
                                                Thanks for placing your
                                                estimate request! We'll
                                                go over details and
                                                get back as soon as
                                                possible.
                                                </td>
